package com.bolsos.controlador;

import com.bolsos.config.Fecha;
import com.bolsos.modelo.Carrito;
import com.bolsos.modelo.Categoria;
import com.bolsos.modelo.Cliente;
import com.bolsos.modelo.ClienteDAO;
import com.bolsos.modelo.Compra;
import com.bolsos.modelo.ComprasDAO;
import com.bolsos.modelo.DetalleCompra;
import com.bolsos.modelo.Pago;
import com.bolsos.modelo.Producto;
import com.bolsos.modelo.ProductoDAO;
import com.bolsos.modelo.Rol;
import com.bolsos.modelo.Tarjeta;
import java.io.File;
                ...
                try {
                    ...
                    for (int i = 0; i < items.size(); i++) {
                        ...
                        if (!fileItem.isFormField()) {
                            File file = new File("C:\\Users\\miki\\3D Objects\\JAVA\\CarritoZenda\\web\\img\\productos\\" + fileItem.getName());
                            fileItem.write(file);
        ...
        try {
            ...
            for (int i = 0; i < items.size(); i++) {
                ...
                if (!fileItem.isFormField()) {
                    ...
                    if (!"".equals(nomfoto)) {
                        File file = new File("C:\\Users\\miki\\3D Objects\\JAVA\\CarritoZenda\\web\\img\\fotouser\\" + fileItem.getName());
                        fileItem.write(file);
