...
<%@page import="com.bolsos.config.Fecha"%>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <c:if test="${subtotal!=',00'}">
                                <a class="form-control text-center"><i class="h5">$ ${subtotal}</i></a>
                            </c:if>
                            <c:if test="${subtotal==',00'}">
                            ...
                            <c:if test="${totalDescuento!=',00'}">
                                <a class="form-control text-center"><i class="h5" style="color: red">$ ${totalDescuento}</i></a>
                            </c:if>    
                            <c:if test="${totalDescuento==',00'}">
                                <a class="form-control text-center"><i class="h5" style="color: red">$ 0,00</i></a>
                            </c:if>    

                            <label>IGV:</label>
                            <c:if test="${igv!=',00'}">
                                <a class="form-control text-center"><i class="h5">$ ${igv}</i></a>
                            </c:if> 
                            <c:if test="${igv==',00'}">
                                <a class="form-control text-center"><i class="h5">$ 0,00</i></a>
                            </c:if> 


                            <label>Total a Pagar:</label>
                            <c:if test="${igv!=',00'}">
                                <a class="form-control text-center"><i class=" h4 primary">$ ${totalPagar}</i></a>
                            </c:if> 
                            <c:if test="${igv==',00'}">
                                <a class="form-control text-center"><i class=" h4 primary">$ 0,00</i></a>
                            </c:if> 
